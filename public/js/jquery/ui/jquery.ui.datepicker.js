...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
			...
			' title="' + prevText + '"><span class="time_pre"></span></a>' :
			(hideIfNoPrevNext ? '' : '<a class="time_pre" title="'+ prevText +'"><span class="time_pre"></span></a>'));
		...
		var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			...
			'.datepicker._adjustDate(\'#' + inst.id + '\', +' + stepMonths + ', \'M\');"' +
			' title="' + nextText + '"><span class="time_next"></span></a>' :
			(hideIfNoPrevNext ? '' : '<a class="time_next" title="'+ nextText + '"><span class="time_next"></span></a>'));
