...
(function ($) {
    ...
    Jconfirm.prototype = {
        ...
        _buildHTML: function () {
            ...
            this.$el.find('.jconfirm-box-container').addClass(this.columnClass).hide();
             ...
             * Settings up buttons
             */
            this.$btnc = this.$el.find('.cd-buttons');
            if (this.confirmButton && this.confirmButton.trim() !== '') {
                this.$confirmButton = $('<li><a class="btn">' + this.confirmButton + '</a></li>').appendTo(this.$btnc).addClass(this.confirmButtonClass);
            }
            if (this.cancelButton && this.cancelButton.trim() !== '') {
                this.$cancelButton = $('<li><a class="btn">' + this.cancelButton + '</a></li>').appendTo(this.$btnc).addClass(this.cancelButtonClass);
            }
            $( '</ul>' ).appendTo(this.$btnc);
            
            /*
             * Settings up buttons   原生
            ...
            */
            ...
            this.setContent();
            this.$el.find('.jconfirm-box-container').show();
            if (this.autoClose)
    ...
    jconfirm.pluginDefaults = {
        template: '<div class="jconfirm"><div class="jconfirm-bg"></div><div class="jconfirm-scrollpane"><div class="container"><div class="row"><div class="jconfirm-box-container span6 offset3"><div class="jconfirm-box" role="dialog" aria-labelledby="labelled" tabindex="-1"><div class="closeIcon"><span class="glyphicon glyphicon-remove"></span></div><div class="title"></div><div class="content"></div><ul class="cd-buttons"></ul><div class="jquery-clear"></div></div></div></div></div></div></div>',
        title: 'Hello',
        ...
        autoClose: false,
        closeIcon: null,
        columnClass: 'col-md-4 col-md-offset-4 col-xs-4 col-xs-offset-4 col-sm-4 col-sm-offset-4',
        onOpen: function () {
        },
        onClose: function () {
        },
