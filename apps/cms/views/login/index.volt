...
<html>
    <head>
        ...
        <link href="{{url.getBaseUri()}}bootstrap/3.3.0/css/bootstrap.min.css" rel="stylesheet" type="text/css">
        <title>FCMS登录</title>
    </head>
    <!-- END HEAD -->
    <!-- BEGIN BODY -->
    <body class="text-center">
	    <div class="container-fluid self_login_box">
            ...
            <form class="" action="" name="" method="" id="">
				...
				<div class="form-group has-feedback">
					<div class="input-group self_input_group">
						<span class="input-group-addon" id="basic-addon2"><span class="glyphicon glyphicon-heart self_icon2"></span></span>
				...
				<div class="form-group">
					<div class="input-group self_input_group">
						<span class="input-group-addon" id="basic-addon3"><span class="glyphicon glyphicon-barcode self_icon3"></span></span>
						<input type="text" class="form-control" aria-describedby="basic-addon3" id="code" placeholder='请输入验证码' style="width:60%;">
        ...
        if( loginname != '' &&  password  != '' && code != '')
        {
            ...
            $.ajax( {
                ...
                "success": function( ret ){
                    if( ret.status === 0 )
                    {
                       location = "{{url.getBaseUri()}}" + 'cms/index/index';
                       return true;
                    }
