    ...
    <body class="wrap">
        ...
        <div class="tab-content">
            <div role="tabpannel" class="tab-pane active" id="base_setting" style="padding-top:20px;">
                <form class="form-horizontal" method="post" action="/admin/sitesetting/save">
                    
                    <div class="form-group has-feedback" >
                        <label class="col-xs-1 control-label">网站名称</label>
                        <div class="col-xs-3">
                            <textarea class="form-control" rows="4" cols="60" id="name" name="form[name]" required="required" value="{% if site.name is defined  %}{{site.name}}{% endif %}"></textarea>
                        </div>
                    ...
                    <div class="form-group has-feedback text-right" >
                        ...
                        <div class="col-xs-3">
                            <textarea class="form-control" rows="4" cols="60" id="domain" name="form[domain]" {% if site.domain is defined and false != site.domain  %}readonly{% endif %} value="{% if site.domain is defined  %}{{site.domain}}{% endif %}"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group has-feedback text-right" >
                        ...
                        <div class="col-xs-3">
                        	<div class="input-group">
						      <input class="form-control" id="icon" onclick="uploadImg();" class="form-control" name="form[logo]" value="{% if site.logo is defined and false != site.logo %}{{site.logo}}{% endif %}"/>
                    ...
                    <div class="form-group has-feedback" >
                        ...
                        <div class="col-xs-3">
                            <textarea class="form-control" rows="4" cols="60" id="seokey" name="form[seokey]" value="{% if site.seokey is defined  %}{{site.seokey}}{% endif %}"></textarea>
                        </div>
                    ...
                    <div class="form-group has-feedback" >
                        ...
                        <div class="col-xs-3">
                            <textarea class="form-control" rows="4" cols="60" id="seodescr" name="form[seodescr]" value="{% if site.seodescr is defined  %}{{site.seodescr}}{% endif %}"></textarea>
                        </div>
                    ...
                    <div class="form-group has-feedback text-right" >
                        ...
                        <div class="col-xs-3">
                            <textarea class="form-control" rows="4" cols="60" name="form[copyright]">{% if site.copyright is defined  %}{{site.copyright}}{% endif %}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group has-feedback text-right" >
                        ...
                        <div class="col-xs-3">
                            <textarea class="form-control" rows="4" cols="60" name="form[static_code]">{% if site.static_code is defined  %}{{site.static_code}}{% endif %}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin-top: 30px;">
                        <div class="col-sm-offset-1 col-sm-12">
                        	<input type="hidden" id="id" name="form[id]" value="{% if site.id is defined  %}{{site.id}}{% endif %}" />
                           	<input type="submit" value="提交" name="submit" class="btn btn-info col-sm-3 col-xs-3">
                        </div>
                    </div>
                </form>
            </div>
