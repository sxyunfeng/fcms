...
<html>
    ...
    <body class="wrap">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation" class="active"><a href="#groupEdit">添加部门</a></li>
        </ul>
            ...
            <div role="tabpannel" class="tab-pane active" id="groupEdit" style="padding-top:20px;">
                <form class="form-horizontal">
                    <div class="form-group has-feedback text-right">
                        ...
                        <div class="col-xs-3">
                            <input class="form-control" type="text" id="name" name="name" placeholder="请输入部门名" value=''/>
                        </div>
                    </div>
                    <div class="form-group has-feedback text-right">
                        <label class="col-xs-2 control-label">排序</label>
                        <div class="col-xs-2">
                            <input class="form-control" type="text" id="name" name="sort" placeholder="请输入排序" value='0'/>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin-top: 30px;">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" class="btn btn-success btn-sm" id="save" style="margin-right: 50px;width:70px;">保存</button>
            ...
            $( function(){
                ...
                $( '#save' ).click( function(){
                    ...
                    if( ! $( 'form span' ).hasClass( 'glyphicon-remove') ) //数据正确可以提交表单了
                    {
                        ...
                        $.post( '/admin/departments/insert', data, function( ret ){
                            if( ! ret.status )
                            {
