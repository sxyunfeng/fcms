			        ...
			        <li class="<?php if( 1 == $i ) echo 'active'; ?> dropdown self_dropdown_toggle__<?php echo $i; ?>">
			          ...
			          <ul class="dropdown-menu self_dropdown_menu__<?php echo $i; ?>">
			          	...
			          	<li>
			          		...
			          		<a href="<?php echo $ch[ 'url' ];?>" target="<?php if( isset( $ch[ 'target' ] ) && 0 != $ch['target'] ) echo '_blank';?>" class="_fcms_static_"><?php echo $ch['name'];?></a>
	...
	<!-- <div class="container" style="margin-top:10px;"> -->
		<div id="myCarousel" class="carousel slide">
	        <ol class="carousel-indicators">
				<?php 
		        	$slides = $this->slidePics->getSlides();
					if( count( $slides ) > 0 )
					{
			...
			<div class="carousel-inner">
				...
				?>
							<div class="item <?php if( 0 == $key ){ echo 'active'; }?>">
								<a href="http://<?php if( $slide->url ){ echo $slide->url; }?>" target="_blank" ><img src="<?php if( $slide->dir ){ echo $slide->dir; }?>" alt="<?php if( $slide->alt ){ echo $slide->alt; }?>" /></a>
