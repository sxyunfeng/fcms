...
<html>
    ...
    <body class="wrap">
        <ul class="nav nav-tabs" role="tablist" id="tabs">
            ...
            <li role="presentation" class="active"><a href="#edit">添加支付</a></li>
        </ul>
            ...
            <div role="tabpannel" class="tab-pane active" id="edit" style="padding-top:20px;">
                <form class="form-horizontal">
                    <div class="form-group has-feedback text-right">
                        ...
                        <div class="col-xs-3">
                            <input class="form-control" type="text" placeholder="请输入支付名称" name="pay_name" value="{{ plugin[ 'name'] | escape_attr }}">
                        </div>
                    </div>
                    <div class="form-group has-feedback text-right">
                        <label class="col-xs-2 control-label">合作者身份id</label>
                        <div class="col-xs-3">
                            <input class="form-control" type="text" placeholder="请输入合作者身份id" name="partner_id" value="">
                        </div>
                    </div>
                    <div class="form-group has-feedback text-right">
                        <label class="col-xs-2 control-label">安全校验码key</label>
                        <div class="col-xs-3">
                            <input class="form-control" type="text" placeholder="请输入安全校验码key" name="partner_key" value="">
                        </div>
                    </div>
                    <div class="form-group has-feedback text-right">
                        <label class="col-xs-2 control-label">排序</label>
                        <div class="col-xs-3">
                            <input class="form-control" type="text" placeholder="请输入排序" name="sort" value="0">
                        </div>
                    </div>
                    <div class="form-group has-feedback text-right">
                    ...
                    <div class="form-group" style="margin-top: 30px;">
                        ...
                        <input type="hidden" name="plugin_id"  value="{{ plugin[ 'id' ] | escape_attr }}" />
                    </div>
                </form>
            </div>
         </div>
     ...
     $(function () {
        ...
        $( '#save' ).click( function(){
            ...
            var key = '&<?php echo $this->security->getTokenKey();?>=<?php echo $this->security->getToken();?>';
                data += key;
            $( '.loading' ).show();
           $.post( '/admin/payconfig/insert', data, function( ret ){
               if( ! ret.status )
               {
