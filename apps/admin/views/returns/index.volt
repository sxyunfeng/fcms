...
<html>
    ...
    <body class="wrap">
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#orderList">退货单</a></li>
        </ul>
...
<script>
    $( function(){
       /*----------------删除-----------------*/
       $( 'table' ).delegate( '.returnDelete', 'click', function(){
            var isDel = confirm( '是否删除退货单' );
            if( isDel )
            {
                ...
                $.post( '/admin/returns/delete', data, function( ret ){
                    if( !ret.status )
                    {
