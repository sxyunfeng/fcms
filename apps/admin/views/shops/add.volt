...
<html>
    ...
    <body class="wrap">
        <ul class="nav nav-tabs" role="tablist" id="tabs">
            ...
            <li role="presentation" class="active"><a href="#shopAdd">添加商铺</a></li>
        </ul>
        <div class="tab-content">
            <div role="tabpannel" class="tab-pane active" id="shopAdd" style="padding-top:20px;">
                ...
                <form class="form-horizontal" id="shopInfo">
                    ...
                    <div class="form-group has-feedback text-right">
                        ...
                        <div class="col-xs-3">
                            <input class="form-control" type="text" id="name" name="name" placeholder="请输入商铺名称" value=''/>
                        </div>
                    </div>
                    <div class="form-group has-feedback text-right">
                        <label class="col-xs-2 control-label">联系人</label>
                        <div class="col-xs-2">
                            <input class="form-control" type="text" id="linkman" name="linkman" placeholder="请输入商铺联系人" value=''  />
                        </div>
                    </div>
                    <div class="form-group  has-feedback text-right">
                        <label class="col-xs-2 control-label">联系电话</label>
                        <div class="col-xs-2">
                            <input class="form-control" type="text" id="tel" name="tel" placeholder="请输入联系电话" value=""/>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-10">
                            <div class="col-xs-2" style="padding-left:0;">
                                <select class="form-control input-sm" id="provinces" name="province">
                                    ...
                                    <option value="{{ item[ 'id' ] }}" {% if item[ 'id' ] == 27 %} selected {% endif %}>{{ item[ 'name' ] }}</option>
                                    {% endfor %}
                                </select>
                            </div>
                            <div class="col-xs-2">
                                <select class="form-control input-sm" id="citys" name="city" >
                                    {% for item in citys %}
                                    <option value="{{ item[ 'id' ] }}" {% if item[ 'id' ] == 438 %} selected {% endif %}>{{ item[ 'name' ] }}</option>
                                    {% endfor %}
                                </select>
                            </div>
                            <div class="col-xs-2" id="">
                                <select class="form-control input-sm" id="countrys" name="district">
                                    ...
                                    <option value="{{ item[ 'id' ] }}" {% if item[ 'id' ] == 4673 %} selected {% endif %}>{{ item[ 'name' ] }}</option>
                                    {% endfor %}
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group has-feedback text-right">
                        ...
                        <div class="col-xs-3"> 
                            <input class="form-control" type="text" name="detail_addr" value="" placeholder="请输入商铺详细地址"/>
                        </div>
                    </div>
                    <div class="form-group text-right">
                        <label class="col-xs-2 control-label" >当前状态</label>
                        <div class="col-xs-3 text-left">
                            <label class="radio-inline"> <input type="radio" value="1" name="status" checked/>正常</label>
                            <label class="radio-inline"> <input type="radio" value="2" name="status"  />欠款</label>
                            <label class="radio-inline"> <input type="radio" value="3" name="status"  />下架</label>
                            <label class="radio-inline"> <input type="radio" value="4" name="status" />未审核</label>
                        </div>
                    </div>
                    <div class="form-group text-right qq">
                        ...
                        <div class="col-xs-3 ">
                            <table class="table table-bordered text-center">
                                <tbody>
                                    <tr>
                                        <td><input class="qqNumber" name="qq[]" type="text" value="123456" placeholder="请输入qq号码"></td>
                    ...
                    <div class="form-group" style="margin-top: 30px;">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" class="btn btn-success btn-sm" id="shopInsert">保存</button>
...
$( function(){
    ...
    $( '#shopInsert' ).click( function(){
        ...
        if( !$( '#shopInfo span' ).hasClass( 'glyphicon-remove' ) ) //数据正确可以提交表单了
        {
            ...
            $.post( '/admin/shops/insert', data, function( ret ){
                if( !ret.status )
                {
