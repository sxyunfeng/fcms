...
<html>
    ...
    <body class="wrap">
        <ul class="nav nav-tabs" role="tablist" id="tabs">
            ...
            <li role="presentation"><a href="#articleContent"  >编辑文章内容</a></li>
        </ul>
            ...
            <div role="tabpannel" class="tab-pane active" id="articleEdit" style="padding-top:20px;">
                <form class="form-horizontal">
                    ...
                    <div class="form-group has-feedback text-right">
                        ...
                        <div class="col-xs-3">
                            <input class="form-control" type="text" id="title" name="title" placeholder="请输入文章标题" required="required" value="{{ article[ 'title' ]}}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group has-feedback text-right">
                        ...
                        <div class="col-xs-3">
                            <input class="form-control" type="text" id="keywords" name="keywords" placeholder="请输文章关键字" value="{{ article[ 'keywords' ]}}"/>
                        </div>
                    </div>
                     ...
                     <div class="form-group has-feedback text-right" >
                        ...
                        <div class="col-xs-3">
                            <textarea class="form-control" cols='2' type="text" id="description" name="description"  >{{ article[ 'description' ]}}</textarea>
                        </div>
                    </div>
                   <div class="form-group has-feedback text-right">
                        <label class="col-xs-2 control-label">文章作者</label>
                        <div class="col-xs-2">
                            <input class="form-control" type="text" id="author" name="author" placeholder="请输入文章作者" value="{{ article[ 'author' ]}}" disabled/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-2">
                        	<input class="form-control"  type="text" id="pubtime" name="pubtime" value="{{ article[ 'pubtime' ]}}" />
                        </div>
                    </div>
                        ...
                        <div class="col-xs-5">
                           <div id="d_tag2">
                           	{% if tags is defined and tags is not empty %}
                           		{% for item in tags %}
                           			<p title="单击删除该标签" onclick="removeBtn(this)">{{item.name}}</p>
                           		{% endfor %}
                           	{% endif %}
                           </div>
									...
									<tr>
										...
										{% if alltags is defined and alltags is not empty %}
											{% for atags in alltags %}
				                           		<a target="_blank" class="" onclick="setTag2(this);return false;">{{ atags.name }}</a>
											{% endfor %}
										{% endif %}
										</td>
									</tr>
	    ...
	    $( function(){  
	        ...
	        //文章取消   跳转到商品添加网页
	         $( '#articleContentCancel' ).click( function() { 
	             $('#tabs a[href="#articleEdit"]').tab( 'show' );
	         });
	    ...
	    function setTag2( item )
	    {
	    	...
	    	if( $( item ).hasClass( 'act' ) || true == isRemove )
			{//移除
