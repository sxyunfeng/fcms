...
<html>
    ...
    <body class="wrap">
        <ul class="nav nav-tabs" role="tablist" id="tabs">
            ...
            <li role="presentation" class="active"><a href="#couponEdit">{% if isRead is defined %} 查看优惠券 {% else %}编辑优惠券{% endif %}</a></li>
        
        </ul>
        <div class="tab-content">
            <div role="tabpannel" class="tab-pane active" id="couponEdit" style="padding-top:20px;">
                ...
                <form class="form-horizontal" id="">
                    ...
                    <div class="form-group has-feedback text-right ">
                     ...
                     <div class="form-group  has-feedback text-right range" style="display:{{ coupon[ 'isRange' ] }}">
                        ...
                        <div class="col-xs-2">
                            <input class="form-control form_datetime"  id="datefrom" name="datefrom" type="text" value="{{ coupon[ 'datefrom'] | escape_attr }}"  />
                        </div>
                    </div>
                     <div class="form-group  has-feedback text-right range" style="display: {{ coupon[ 'isRange' ] }}">
                        <label class="col-xs-2 control-label">终止日期</label>
                        <div class="col-xs-2">
                            <input class="form-control form_datetime" id="dateto" name="dateto" type="text" value="{{ coupon[ 'dateto'] | escape_attr }}"  />
                        </div>
                    </div>
                     <div class="form-group  has-feedback text-right interval  " style="display: {{ coupon[ 'isInterval' ] }}">
                        ...
                        <div class="col-xs-2">
                            <input class="form-control" id="dateinterval" name="dateinterval" type="text"  placeholder="请输入从今天算起，优惠券有效天数" value="{{ coupon[ 'dateinterval'] | escape_attr }}"  />
                        </div>
                    </div>
                    <div class="form-group  has-feedback text-right">
