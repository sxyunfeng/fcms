...
<html>
    ...
    <body class="wrap">
        <ul class="nav nav-tabs" role="tablist" id="tabs">
            <li role="presentation" class=""><a href="{{ url( 'admin/members/index' ) | e }}">会员</a></li>
            ...
            <div role="tabpannel" class="tab-pane active" id="memberRead" style="padding-top:20px;">
                ...
                <form class="form-horizontal" id="memberInfo">
                    <div class="form-group has-feedback text-right">
                        ...
                        <div class="col-xs-3">
                            <input class="form-control" type="text" id="loginname" name="login_name" placeholder="请输入账号" value='{{ member[ 'login_name' ] | e }}'  />
                        </div>
                    </div>
                    <div class="form-group has-feedback text-right">
                        <label class="col-xs-2 control-label">姓名</label>
                        <div class="col-xs-3">
                            <input class="form-control" type="text" id="name" name="username" placeholder="请输入姓名" value='{{ member[ 'username' ] | e }}'/>
                        </div>
                    </div>
                    <div class="form-group  has-feedback text-right">
                        <label class="col-xs-2 control-label">邮箱</label>
                        <div class="col-xs-3">
                            <input class="form-control" type="email" id="email" name="email" placeholder="请输入邮箱" value="{{ member[ 'email' ] | e }}"/>
                        </div>
                    </div>
                    <div class="form-group has-feedback text-right">
                        <label class="col-xs-2 control-label">手机</label>
                        <div class="col-xs-2">
                            <input class="form-control" type="text" id="loginname" name="mobile_phone" placeholder="请输入手机号" value='{{ member[ 'mobile_phone' ] | e }}'  />
                        </div>
                    </div>
                     <div class="form-group  has-feedback text-right">
                        <label class="col-xs-2 control-label">积分</label>
                        <div class="col-xs-2">
                            <input class="form-control" type="email" id="rest_points" name="email" placeholder="请输积分" value="{{ member[ 'rest_points' ] | e }}"/>
                        </div>
                    </div>
                     <div class="form-group  has-feedback text-right">
                     ...
                     <div class="form-group  has-feedback text-right">
                        ...
                        <div class="col-xs-2">
                            <input class="form-control form_datetime" type="text" value="{{ member[ 'birthdate'] | e }}"  />
                        </div>
                    </div>
                        ...
                        <label class="col-xs-2 control-label">出生地</label>
                           <div class="col-xs-2">
                            <select class="form-control" id="provinces" >
                                ...
                                <option value="{{ item[ 'id' ] | e }}" {% if item[ 'id' ] == member[ 'province'] %} selected {% endif %}>{{ item[ 'name' ] }}</option>
                                {% endfor %}
                            </select>
                        </div>
                         <div class="col-xs-2">
                            <select class="form-control" id="citys" >
                                {% for item in citys %}
                                <option value="{{ item[ 'id' ] | e }}" {% if item[ 'id' ] == member[ 'city'] %} selected {% endif %}>{{ item[ 'name' ] }}</option>
                                {% endfor %}
                            </select>
                        </div>
                         <div class="col-xs-2" id="">
                            <select class="form-control" name="address" value="" id="countrys" >
                                ...
                                <option value="{{ item[ 'id' ] | e }}" {% if item[ 'id' ] == member[ 'district'] %} selected {% endif %}>{{ item[ 'name' ] }}</option>
                                {% endfor %}
                            </select>
                        </div>
                    </div>
